...
gap_file: data/gap-analysis/gap-michael-baker-international-ba-requirements-2026.md
jd_file: data/jds/normalized/jd-michael-baker-international-ba-requirements-2026-v1.md
role_file: data/roles/role-michael-baker-international-ba-requirements-2026.md
resume_file: data/resume-versions/teal-export/resume-michael-baker-international-ba-requirements-2026-teal-v1.md
jd_intelligence_file: data/jd-intelligence/jd-intelligence-michael-baker-international-ba-requirements-2026.json
---

# Interview Prep — Michael Baker International — Software Requirements Analyst (GIS)
...
1. How would you gather requirements for a GIS or geospatial application?
...
- If asked about gis, be direct that you have not been the primary gis administrator, then bridge to enterprise application support, requirements, UAT, workflow analysis, and fast ramp-up.
