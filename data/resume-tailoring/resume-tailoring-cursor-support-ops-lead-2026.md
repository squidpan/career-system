...
status: draft
run_id: run-2026-06-03-resume-tailoring-v1
source: career-system
company: Cursor
title: Support Operations Systems Lead
role_code: support-ops-lead
confidence_score: 100
gap_file: data/gap-analysis/gap-cursor-support-ops-lead-2026.md
jd_intelligence_file: data/jd-intelligence/jd-intelligence-cursor-support-ops-lead-2026.json
role_file: data/roles/role-cursor-support-ops-lead-2026.md
resume_file: data/resume-versions/teal-export/resume-cursor-support-ops-lead-2026-teal-v1.md
---

# Resume Tailoring — Cursor — Support Operations Systems Lead
...
- Application support, production operations, incident triage, and risk-aware escalation
...
- HRIS/Workday-specific language unless the JD requires it
- GIS/geospatial language unless the JD requires it
- Deep market-data terminology unless the JD is financial-data or trading focused
- Detailed insurance workflow language unless domain fit is important
- Heavy SRE/Linux/networking detail unless the role is support/SRE-oriented

## Resume Story Recommendations

- Use deployment runbooks and production readiness as the operations story
- Use REST API validation against Oracle as a technical validation story
